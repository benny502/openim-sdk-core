...
FOUNDATION_EXPORT NSString* _Nonnull Open_im_sdkCreateAccountMessage(NSString* _Nullable operationID, NSString* _Nullable accountInfo);
...
FOUNDATION_EXPORT NSString* _Nonnull Open_im_sdkCreateOrderMessage(NSString* _Nullable operationID, NSString* _Nullable orderInfo);
...
FOUNDATION_EXPORT void Open_im_sdkGetUsersInfoWithStrange(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable userIDs);
