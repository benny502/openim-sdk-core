...
func (c *Conversation) CreateOrderMessage(ctx context.Context, order *sdk_struct.OrderElem) (*sdk_struct.MsgStruct,
	error) {
	s := sdk_struct.MsgStruct{}
	err := c.initBasicInfo(ctx, &s, constant.UserMsgType, constant.Order)
	if err != nil {
		return nil, err
	}
	s.OrderElem = order
...
func (c *Conversation) CreateAccountMessage(ctx context.Context, account *sdk_struct.AccountElem) (*sdk_struct.MsgStruct,
	error) {
	s := sdk_struct.MsgStruct{}
	err := c.initBasicInfo(ctx, &s, constant.UserMsgType, constant.Account)
	if err != nil {
		return nil, err
	}
	s.AccountElem = account
	return &s, nil
}
