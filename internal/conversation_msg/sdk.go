...
func (c *Conversation) msgStructToLocalChatLog(src *sdk_struct.MsgStruct) *model_struct.LocalChatLog {
	...
	case constant.Order:
		lc.Content = utils.StructToJsonString(src.OrderElem)
	case constant.Account:
		lc.Content = utils.StructToJsonString(src.AccountElem)
...
func (c *Conversation) SendMessage(ctx context.Context, s *sdk_struct.MsgStruct, recvID, groupID string, p *sdkws.OfflinePushInfo) (*sdk_struct.MsgStruct, error) {
	...
	case constant.Order:
		s.Content = utils.StructToJsonString(s.OrderElem)
	case constant.Account:
		s.Content = utils.StructToJsonString(s.AccountElem)
	case constant.Face:
