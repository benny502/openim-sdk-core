...
func registerFunc() {
	...
	js.Global().Set("createOrderMessage", js.FuncOf(wrapperConMsg.CreateOrderMessage))
	js.Global().Set("createAccountMessage", js.FuncOf(wrapperConMsg.CreateAccountMessage))
