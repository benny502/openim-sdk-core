...
func (w *WrapperConMsg) CreateOrderMessage(_ js.Value, args []js.Value) interface{} {
	return event_listener.NewCaller(open_im_sdk.CreateOrderMessage, nil, &args).AsyncCallWithOutCallback()
}
func (w *WrapperConMsg) CreateAccountMessage(_ js.Value, args []js.Value) interface{} {
	return event_listener.NewCaller(open_im_sdk.CreateAccountMessage, nil, &args).AsyncCallWithOutCallback()
}
