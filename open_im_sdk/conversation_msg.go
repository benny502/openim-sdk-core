...
func CreateOrderMessage(operationID string, orderInfo string) string {
	return syncCall(operationID, UserForSDK.Conversation().CreateOrderMessage, orderInfo)
}
func CreateAccountMessage(operationID string, accountInfo string) string {
	return syncCall(operationID, UserForSDK.Conversation().CreateAccountMessage, accountInfo)
}
